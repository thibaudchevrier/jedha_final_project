...
from mask_rcnn_matterport import utils
...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    data = io.BytesIO()
    plt.savefig(data, bbox_inches="tight", format='jpeg', pad_inches=0)
    return f"data:image/jpg;base64,{base64.b64encode(data.getvalue()).decode('utf-8')}"
